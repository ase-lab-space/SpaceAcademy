...
![シェルに気温・気圧・湿度のタプルが1秒おきに表示されている様子(赤枠部分)](images/class6/07_spi_result.png)
...
![Plotterのグラフ(右、細かく揺れている)と、平均値・分散・標準偏差の出力結果(左、赤枠部分)](images/class6/14_sensor_noise_stats.png)
