...
| 場所 | 名前 | 役割 |
| --- | --- | --- |
| 画面中央の広い部分 | キャンバス(ビューポート) | 実際にモデルを作る作業スペース |
| 左上のツリー | ブラウザ(デザインツリー) | 今まで作ったスケッチ・部品の一覧 |
| 画面上部 | ツールバー | スケッチ・押し出し・フィレットなど、使う機能のボタンが並ぶ場所 |
| 画面下部 | タイムライン | 作業履歴。アイコンをクリックすると、その時点の状態に戻せる |
| 画面右下あたり | ナビゲーションキューブ | 視点をぐるぐる回すためのサイコロ型アイコン |
視点の操作は、この3つだけ覚えておけば十分です。

![画面](images/class1/image-11.png)
...
迷子になったら、画面下のナビゲーションバーにある **Fit** ボタンを押してください。モデル全体が画面にちょうど収まるように、視点が自動で戻ります。

操作を始める前に、この3つのショートカットも覚えておくと安心です。

- 元に戻す:`Ctrl + Z`(失敗しても戻せるので、怖がらず試してよい)
- 全体表示:画面下のナビゲーションバーの **Fit**
...
スケッチ
![スケッチ](images/class1/image-12.png)
押し出し
![押し出し](images/class1/image-14.png)
フィレット
![フィレット](images/class1/image-13.png)
