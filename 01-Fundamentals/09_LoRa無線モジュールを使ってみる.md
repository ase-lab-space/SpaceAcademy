...
![ブレッドボード上での配線イメージ(Fritzing)](images/class9/02b_breadboard_fritzing.png)

> 💡 お手元の基板の実際のシルク印字(ピン名の刻印)と、必ず照らし合わせて配線してください。
...
![実際に配線した2セット(Pico W + LoRaモジュール評価ボード + アンテナ)の様子](images/class9/02c_breadboard_photo.jpg)

![送信側・受信側それぞれのThonnyシェルでの実行結果(送信: PING 0, 1, 2… / 受信: …)](images/class9/07_lora_result.png)
...
![Plotterで観察したAUXピンの波形(3秒おきに一瞬LOWへ落ち込む様子)](images/class9/07b_aux_plotter_result.png)
